...
contract("Token", ([deployer, receiver, exchange]) => {
  ...
  describe("deployment", () => {
    it("tracks the name", async () => {
      ...
      // 3- Check the token name is 'My name'
  ...
  describe("aproving tokens", () => {
    ...
    describe("success", () => {
      it("allocates an allowance for delegated token spending on exchange", async () => {
        // deployer is the person who is approving the tokens
        // exchange is the place that have approved them andwill return the amount approved
